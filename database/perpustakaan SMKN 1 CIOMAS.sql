...
--
-- Menampilkan data untuk tabel `admin`
--
...
--
-- Menampilkan data untuk tabel `buku`
--
...
--
-- Menampilkan data untuk tabel `kategori_buku`
--
...
--
-- Struktur tabel untuk tabel `member`
--
...
--
-- Menampilkan data untuk tabel `member`
--
...
--
-- Struktur tabel untuk tabel `pengembalian`
--
...
--
-- NILAI OTOMATIS for dumped tables
--

--
-- NILAI OTOMATIS for table `admin`
--
ALTER TABLE `admin`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- NILAI OTOMATIS for table `peminjaman`
--
ALTER TABLE `peminjaman`
  MODIFY `id_peminjaman` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;

--
-- NILAI OTOMATIS for table `pengembalian`
--
ALTER TABLE `pengembalian`
