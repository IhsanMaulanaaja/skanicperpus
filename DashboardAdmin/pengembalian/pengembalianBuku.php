...
$queryStr = "SELECT pengembalian.id_pengembalian, pengembalian.id_buku, buku.judul, buku.kategori, buku.cover, pengembalian.nisn, member.nama, member.kelas, member.jurusan, member.foto, admin.nama_admin, pengembalian.buku_kembali, pengembalian.keterlambatan, pengembalian.denda
FROM pengembalian
...
<html lang="id">
  <head>
    ...
    <title>Riwayat Pengembalian - Admin SkanicPerpus</title>
    <!-- Google Fonts -->
      ...
      <div class="container-fluid px-lg-4">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
          <div>
            ...
            <p class="text-muted small mb-0">Total <?= count($dataPengembalian); ?> riwayat buku dikembalikan ditemukan</p>
          </div>
        </div>
          ...
          <form action="" method="get" class="row g-3 align-items-end">
            ...
            <div class="col-md-2 d-flex gap-2">
              ...
              <?php if(!empty($tgl_dari) || !empty($tgl_sampai) || !empty($keyword)) : ?>
                <a href="pengembalianBuku.php" class="btn btn-modern-secondary btn-sm" title="Reset Filter">
                  ...
                  <?php foreach ($dataPengembalian as $item) : ?>
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="deletePengembalian.php?id=<?= urlencode($item["id_pengembalian"]); ?>" class="btn btn-modern-danger btn-sm" onclick="return confirm('Yakin ingin menghapus riwayat pengembalian ini?');" title="Hapus Data">
